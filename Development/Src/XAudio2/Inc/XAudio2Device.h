...
#if _WINDOWS
// XAudio2 Redist (2.9) uses XAUDIO2_ANY_PROCESSOR instead of XAUDIO2_DEFAULT_PROCESSOR
#ifndef XAUDIO2_ANY_PROCESSOR
#define XAUDIO2_ANY_PROCESSOR	0xFFFFFFFF
#endif
#ifndef AUDIO_HWTHREAD
#define AUDIO_HWTHREAD		XAUDIO2_ANY_PROCESSOR
#endif
#endif
